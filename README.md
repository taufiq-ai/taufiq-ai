...
I'm a final year student of BSc in Computer Science & Engineering with 1+ years of experience in Machine Learning as an Undergraduate Research Assistant. I have done my 1st publication on Machine Learning (ML) & Natural Language Processing (NLP) and another one on Healthcare Informatics is under the review process in a prestigious IEEE conference proceeding. My technical & research interest is in, but not limited to, Healthcare Informatics, Medical Image Processing, NLP, Computer Vision.
